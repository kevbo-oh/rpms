...
- Remove unneeded old APR version number patch
- Add new Fedora patches subversion-1.7.4-kwallet2.patch,
  subversion-1.7.9-rubybind.patch, subversion-1.7.9-swighash.patch
